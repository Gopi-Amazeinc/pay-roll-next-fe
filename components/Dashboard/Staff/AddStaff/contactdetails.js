            ...
            <div className="row">
              <div className="col-12">
                ...
                <div style={customPopupDivision.popupcontent}>
                  <div style={customPopupDivision.popupinputs}>
                    <p>
                      Emergency Contact Name 1<span>*</span>
                    </p>
                    <div>
                      <input
                        type="text"
                  ...
                  <div style={customPopupDivision.popupinputs}>
                    <p>
                      Contact Mobile Number<span>*</span>
                    </p>
                    <div>
                      <input
                        type="text"
                  ...
                  <div style={customPopupDivision.popupinputs}>
                    <p>
                      Contact Email Address<span>*</span>
                    </p>
                    <div>
                      <input
                        type="text"
            ...
            <div className="row">
              <div className="col-12">
                ...
                <div style={customPopupDivision.popupcontent}>
                  <div style={customPopupDivision.popupinputs}>
                    <p>
                      Emergency Contact Name 2<span>*</span>
                    </p>
                    <div>
                      <input
                        type="text"
