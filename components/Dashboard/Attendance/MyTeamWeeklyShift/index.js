...
const Index = () => {
  ...
  const getData = async () => {
    ...
    const res = await apiService.commonGetCall(
      "Payroll/GetStaffShiftDetailsBySupervisor?Supervisor=" + userID
    );
  ...
  const approve = async (id) => {
    const res = await apiService.commonPostCall(
      "Payroll/ApproveStaffShiftDetails",
      id
    );
  ...
  const onReject = async () => {
    ...
    const res = await apiService.commonPostCall(
      "Payroll/RejectStaffShiftDetails",
      Reason,
      ID
    );
  ...
  const exportToExcel = () => {
    let element = document.getElementById("myteamshiftdeatailid");
    if (element) {
        ...
        <div className="col-lg-12">
          <div className="row">
            ...
            <div className="col-lg-3" style={{ marginLeft: "-30px" }}>
              <br />
              <Link
                href="/Attendance/MyTeamWeeklyShift"
                className={Styles.mainheader}
              >
                {" "}
                My Team Weekly Shift
              </Link>
              <div
                    ...
                    .map((data) => {
                      return (
                        <tr key={data.id}>
                          ...
                          <td>
                            <button
                              onClick={approve.bind(this, data.id)}
                              className="edit-btn"
                            >
                              Approve
                            </button>
                            &nbsp;
                            <button
                              onClick={reject.bind(this, data.id)}
                              className="edit-btn"
                            >
                              Reject
                            </button>
                ...
                <ModalBody>
                  <div className="row">
                    <div className="col-lg-12">
                      ...
                      ></textarea>
                      {errors.reason && (
                        <p className="text-danger">Please enter Valid Reason</p>
                      )}
                    </div>
                  </div>
                </ModalBody>
                <ModalFooter>
                  <div className="row">
                    ...
                    <div className="col-lg-5">
                      <button onClick={onReject} className="edit-btn">
                        Reject
                      </button>
                    </div>
                  </div>
