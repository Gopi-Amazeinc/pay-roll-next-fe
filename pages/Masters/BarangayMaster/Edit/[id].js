...
const BarangayEdit = () => {
  ...
  // useEffect(() => {
    ...
    //           let response = apiService.commonGetCall(hostURL + "Master/GetBarangayMasterByID?ID=" + id);
  ...
  return (
   ...
   <BarangayMasterForm editData={{id}}/>
...
//                 ">
//                   <Link href="/Masters/BarangayMaster"><button className='AddButton' style={{ float: "right", marginLeft: "5px" }} tabindex="0">CANCEL</button></Link>
//                   <button type='submit' className='AddButton' style={{ float: "right" }}>Update</button>
//                 </div>
//               </div>
//             </form>
//           </div>
