...
function Leaveform() {
    ...
    function clearForm(LeaveData = null) {
        ...
        let details = {
            ...
            "AnnualEntitlement": LeaveData ? LeaveData.annualEntitlement : "",
    ...
    const submit = async (data) => {
        ...
        if (actionType == "insert") {
            await apiService.commonPostCall("Payroll/InsertLeaveConfiguration", data);
            Swal.fire("Data Inserted successfully");
            console.log("Insertde data", data)
            router.push("//Leaveconfiguration");
        } else {
            await apiService.commonPostCall("Payroll/UpdateLeaveConfiguration", data);
