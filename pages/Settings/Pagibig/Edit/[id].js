...
function PagibigID() {
    ...
    const getData = async () => {
        if (id) {
            let response = await axios.get(hostURL + "HR/GetPagibigconfogarationByID?ID=" + id);
    ...
    async function onSubmit(data) {
        await axios.post(hostURL + "HR/UpdatePagibigconfogaration", data); // this is for updating or Modifiying the data using  Update Api call
