                            ...
                            <div className=" card shadow modal-dialog modal-lg">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        ...
                                        <p className="modal-title Heading1" style={{
                                            paddingLeft: "5px",
                                            fontSize: "19px",
                                            fontWeight: "700",
                                            color: "#3247d5"
                                        }}><b>Debit Authorization Report</b></p><br />
                                        <br /><br /><br /><hr />
                                    </div>
                                    <div className="modal-body">
                                        <div className="row">
                                            <div className="col-lg-3"><label className="Text mx-3">Year :</label><br /><br /><label className="Text mx-3">Month:</label><br /><br /><br /><label className="Text mx-3">Pay Period :</label>
                                                <br /><br /></div>
